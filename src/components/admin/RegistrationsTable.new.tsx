...
import { MoreHorizontal, PlusCircle, CheckCircle, XCircle, Clock, Check, HelpCircle, Eye } from 'lucide-react';
...
const getStatusInfo = (status: string): { variant: BadgeVariant; icon: any; label: string } => {
  switch (status) {
    ...
    case 'Menunggu Pengumpulan Berkas': return { variant: 'secondary', icon: Clock, label: 'Menunggu Berkas' };
    case 'Berkas Diterima': return { variant: 'default', icon: CheckCircle, label: 'Berkas Diterima' };
